...
enum OptionsFields {
	...
	JIRA__JQL_TO_FIND_ISSUE_FOR_UPDATE('jira__jql_to_find_issue_for_update', 'By default `labels = "alert[${context.alert.hashCode()}]"`. Provide false or empty value to do not search previous issues', 'labels = "alert[${context.alert.hashCode()}]"'),
